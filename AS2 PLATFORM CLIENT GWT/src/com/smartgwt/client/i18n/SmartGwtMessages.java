...
public interface SmartGwtMessages extends com.google.gwt.i18n.client.Messages {
  ...
  @DefaultMessage("Učitavanje aplikacije<br>Molimo pričekajte...")
  @Key("loading_msg")
  String loadingMsg();
  
  @DefaultMessage("Molimo pričekajte...")
  @Key("waitPopup_please_wait")
  String waitPopup_please_wait();
  
  //Users
  @DefaultMessage("Nemate pravo pristupa aplikaciji!")
  @Key("user_authorizationError")
  String user_authorizationError();
  
  @DefaultMessage("Potrebna prijava u aplikaciju")
  @Key("user_loginRequired")
  String user_loginRequired();
  
  @DefaultMessage("Novi dokument")
  @Key("toolbar_new_document")
  String toolbar_new_document();
  
  @DefaultMessage("Pregled")
  @Key("toolbar_preview")
  String toolbar_preview();
  
  @DefaultMessage("Privitak")
  @Key("toolbar_attachement")
  String toolbar_attachement();
