...
public class AS2ToolBar extends HLayout {
    ...
    public AS2ToolBar(ListGrid listGrid, ValuesManager vm) {
        super();
    ...
    public void setMcardToolbar(){
    	ToolStripButton first = new ToolStripButton();
        first.setTitle("Podaci");
        ToolStripButton second = new ToolStripButton();
        second.setTitle("Obrada: uvjeti");
        ToolStripButton third = new ToolStripButton();
        third.setTitle("Kreditni skoring");
        ToolStripButton fourth = new ToolStripButton();
        fourth.setTitle("Zaključak/odluka/status");
        ToolStripButton fifth = new ToolStripButton();
        fifth.setTitle("Privitak");
        toolStrip.setMembers(first,second,third,fourth,fifth);
            }
}