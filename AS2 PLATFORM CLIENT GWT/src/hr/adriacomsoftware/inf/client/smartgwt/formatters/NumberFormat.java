...
//    private String inputDecimalSeparator = COMMA; // decimal character used on the original string
...
//    private String groupingSeparator = PERIOD; // thousands grouping character
//    private String decimalSeparator = COMMA; // decimal point character
...
//    	DecimalFormat decf = new DecimalFormat(amountFormat);
//    	return decf.format(num);
    ...
    {
//    	double number = asNumber(num, inputDecimalSeparator);
...
//        BigDecimal parsed;
//        try {
////        	Double doubleNewVal = Double.parseDouble(newVal);
//            parsed = new BigDecimal (newVal);
//            if(newVal==null || newVal.length()<0  )
//           /*if(doubleNewVal.isInfinite() || doubleNewVal.isNaN())*/ parsed = BigDecimal.ZERO;
//        }
//        catch (NumberFormatException e) {
//            parsed = new BigDecimal(0);
//        }
//
//        return isPercentage ? parsed.divide(BigDecimal.valueOf(100)): parsed;
